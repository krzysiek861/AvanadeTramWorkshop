...
<template>
    <div class="params-list-content">
        ...
        <div class="param-value"><span class="background">000</span><span class="value">{{
        store.getters['weight/weightInTons'] }}</span></div>
    </div>
</template>

<style scoped>
.params-list-content {
    background-image: url('@/assets/img/LICZNIKI_SCREEN.png');
    width: 593px;
    height: 297px;
    margin-right: 8px;
    display: flex;
